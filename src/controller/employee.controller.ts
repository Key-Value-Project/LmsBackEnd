...
class EmployeeController {
    ...
    public createEmployee = async (req: RequestWithUser, res: Response, next: NextFunction) => {
        try {
            Permission.employeePermission(req, [Role.HR, Role.ADMIN], ['You are not authorized to create an employee']);
    ...
    public deleteEmployee = async (req: RequestWithUser, res: Response, next: NextFunction) => {
        const { id } = req.params;
        try {
            Permission.employeePermission(req, [Role.HR, Role.ADMIN], ['You are not authorized ']);
